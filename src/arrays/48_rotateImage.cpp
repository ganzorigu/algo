...
// Solution: shift left, top row, right column,bottom row, left column shift
// right, need 4 variables to hold, corner values, because it will be
// overwritten after finishing outer layer, go inside.
...
class Solution
{
  public:
	void rotate(vector<vector<int>> &matrix)
	{
		...
		// after 90 degree rotation, need to update these values, to enter inner
		// layer
		int xStart = 0, yStart = 0, xEnd = matrix.size() - 1,
			yEnd = matrix.size() - 1;
